...
382 |             U: TransmuteFromPtr<T, I::Aliasing, I::Validity, V, R> + SizeEq<T> + ?Sized,
    ...
    = note: the full name for the type has been written to '/home/alti/dev/rust/profiling/target/debug/deps/zerocopy-476953b37c57a097.long-type-1502605762912102366.txt'
...
531 |             T: Read<I::Aliasing, R>,
    ...
    = note: the full name for the type has been written to '/home/alti/dev/rust/profiling/target/debug/deps/zerocopy-476953b37c57a097.long-type-5273025327059504357.txt'
    = note: consider using `--verbose` to print the full type name to the console
    = note: this error originates in the macro `unsafe_impl_try_from_bytes_for_nonzero` (in Nightly builds, run with -Z macro-backtrace for more info)
...
382 |             U: TransmuteFromPtr<T, I::Aliasing, I::Validity, V, R> + SizeEq<T> + ?Sized,
    |                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ required by this bound in `_conversions::<impl Ptr<'a, T, I>>::transmute`
    = note: the full name for the type has been written to '/home/alti/dev/rust/profiling/target/debug/deps/zerocopy-476953b37c57a097.long-type-3124032124602835156.txt'
    = note: consider using `--verbose` to print the full type name to the console
    = note: this error originates in the macro `unsafe_impl_try_from_bytes_for_nonzero` (in Nightly builds, run with -Z macro-backtrace for more info)
...
531 |             T: Read<I::Aliasing, R>,
    |                ^^^^^^^^^^^^^^^^^^^^ required by this bound in `_conversions::<impl Ptr<'a, T, I>>::read_unaligned`
    = note: the full name for the type has been written to '/home/alti/dev/rust/profiling/target/debug/deps/zerocopy-476953b37c57a097.long-type-2959871873777286490.txt'
    = note: consider using `--verbose` to print the full type name to the console
    = note: this error originates in the macro `unsafe_impl_try_from_bytes_for_nonzero` (in Nightly builds, run with -Z macro-backtrace for more info)
...
382 |             U: TransmuteFromPtr<T, I::Aliasing, I::Validity, V, R> + SizeEq<T> + ?Sized,
    |                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ required by this bound in `_conversions::<impl Ptr<'a, T, I>>::transmute`
    = note: the full name for the type has been written to '/home/alti/dev/rust/profiling/target/debug/deps/zerocopy-476953b37c57a097.long-type-14629059028242439031.txt'
    = note: consider using `--verbose` to print the full type name to the console
    = note: this error originates in the macro `unsafe_impl_try_from_bytes_for_nonzero` (in Nightly builds, run with -Z macro-backtrace for more info)
...
531 |             T: Read<I::Aliasing, R>,
    |                ^^^^^^^^^^^^^^^^^^^^ required by this bound in `_conversions::<impl Ptr<'a, T, I>>::read_unaligned`
    = note: the full name for the type has been written to '/home/alti/dev/rust/profiling/target/debug/deps/zerocopy-476953b37c57a097.long-type-12988232306062493853.txt'
    = note: consider using `--verbose` to print the full type name to the console
    = note: this error originates in the macro `unsafe_impl_try_from_bytes_for_nonzero` (in Nightly builds, run with -Z macro-backtrace for more info)
...
382 |             U: TransmuteFromPtr<T, I::Aliasing, I::Validity, V, R> + SizeEq<T> + ?Sized,
    |                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ required by this bound in `_conversions::<impl Ptr<'a, T, I>>::transmute`
    = note: the full name for the type has been written to '/home/alti/dev/rust/profiling/target/debug/deps/zerocopy-476953b37c57a097.long-type-5729563060716668651.txt'
    = note: consider using `--verbose` to print the full type name to the console
    = note: this error originates in the macro `unsafe_impl_try_from_bytes_for_nonzero` (in Nightly builds, run with -Z macro-backtrace for more info)
...
531 |             T: Read<I::Aliasing, R>,
    |                ^^^^^^^^^^^^^^^^^^^^ required by this bound in `_conversions::<impl Ptr<'a, T, I>>::read_unaligned`
    = note: the full name for the type has been written to '/home/alti/dev/rust/profiling/target/debug/deps/zerocopy-476953b37c57a097.long-type-17355424843696321576.txt'
    = note: consider using `--verbose` to print the full type name to the console
    = note: this error originates in the macro `unsafe_impl_try_from_bytes_for_nonzero` (in Nightly builds, run with -Z macro-backtrace for more info)
...
error: /home/alti/dev/rust/profiling/target/debug/deps/libserde_derive-6a56e746d805f22a.so: undefined symbol: __tsan_func_entry
   --> /home/alti/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/serde-1.0.228/src/lib.rs:274:1
    |
274 | extern crate serde_derive;
    | ^^^^^^^^^^^^^^^^^^^^^^^^^^
